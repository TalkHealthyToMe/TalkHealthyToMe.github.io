      ...
      <div className="relative mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 lg:py-40">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 inline-flex items-center rounded-full border border-border/50 bg-card/50 backdrop-blur-sm px-6 py-3 text-sm text-muted-foreground">
            This CUI 2026 workshop will take place in-person in Bremen, Germany as part of the ACM Conversational User Interface conference (CUI). We welcome all conference attendees interested in conversational user interfaces for digital public health—not only authors of accepted workshop papers.
          </div>
        </div>
      </div>
    </section>
